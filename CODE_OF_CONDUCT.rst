...
..
.. This file is part of the *universe.unix* project and is licensed under
...
The *universe.unix* community is made up of members from around the globe with a
...
Members of the *universe.unix* community are open, considerate, and respectful.
...
The *universe.unix* community is dedicated to providing a positive experience
for everyone, regardless of age, gender identity and expression, sexual
orientation, disability, physical appearance, body size, ethnicity, nationality,
race, or religion (or lack thereof), education, or socio-economic status.
...
maintainers of the *universe.unix* project may take any action they deem
